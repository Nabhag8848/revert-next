      ...
      {links.map((link) => {
        ...
        return (
          <Link
            ...
            href={link.href}
            className={cn(
              "flex h-[48px] grow text-gray-50 items-center justify-center gap-2 rounded-md p-3 text-sm font-medium hover:bg-slate-50 hover:text-black md:flex-none md:justify-start md:p-2 md:px-3",
